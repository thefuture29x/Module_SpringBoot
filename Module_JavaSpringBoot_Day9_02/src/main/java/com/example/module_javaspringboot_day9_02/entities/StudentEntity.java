...
public class StudentEntity {
    ...
    private Set<SubjectEntity> listSubject = new HashSet<>();
    ...
    public StudentEntity(Long id, String name, String address, String phoneNumber, List<ScoreEntity> listScore, Set<SubjectEntity> listSubject, List<TimeTableEntity> timeTableEntityList) {
        this.id = id;
        this.name = name;
    ...
    public Set<SubjectEntity> getListSubject() {
        return listSubject;
    }

    public void setListSubject(Set<SubjectEntity> listSubject) {
        this.listSubject = listSubject;
    }
